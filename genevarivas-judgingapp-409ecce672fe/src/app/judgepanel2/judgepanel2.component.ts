...
@Component({
  selector: 'app-judgepanel2',
  templateUrl: './judgepanel2.component.html',
  styleUrls: ['./judgepanel2.component.scss']
})


export class Judgepanel2Component implements OnInit {
  ...
  final() {
    this.dataService.getScore().subscribe(data => {
      ...
      this.array.forEach(element => {
        this.finArray.push({ name: element.name, finScore2: element.total })
      });
      console.log(data)
